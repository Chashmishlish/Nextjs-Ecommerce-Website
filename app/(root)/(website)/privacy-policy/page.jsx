    ...
    return (
        <div>
            ...
            <div className='lg:px-40 px-5 py-20'>
                ...
                <p>
                    At Smilish Store, we are committed to protecting your privacy and ensuring that your personal information is handled in a safe and responsible manner.
                </p>
                ...
                <p className='mt-3'>
                    Thank you for trusting Smilish Store. Your privacy is important to us.
                </p>
            </div>
        </div>
    )
