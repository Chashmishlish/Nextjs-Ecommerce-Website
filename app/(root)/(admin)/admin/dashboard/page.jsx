    ...
    <div className='pt-5'>
      ...
      <div className='mt-10 flex lg:flex-nowrap flex-wrap gap-10'>
        <Card className='rounded-lg lg:w-[70%] w-full p-0'>
          <CardHeader className=' py-3 border [.border=b]:pb-3'>
            <div className='flex justify-between items-center'>
              <span className='font-bold'>Order Overview</span>
              <Button type="button">
        ...
        <Card className='rounded-lg lg:w-[30%] w-full p-0'>
          ...
          <CardHeader className=' py-3 border-b border [.border=b]:pb-3'>
            <div className='flex justify-between items-center'>
              <span className='font-bold'>Orders Status</span>
              <Button type="button">
                <Link href={ADMIN_ORDER_SHOW}>View All</Link>
      ...
      <div className='mt-10 flex lg:flex-nowrap flex-wrap gap-10'>
        <Card className='rounded-lg lg:w-[70%] w-full p-0 block'>
          <CardHeader className=' py-3 border [.border=b]:pb-3'>
            <div className='flex justify-between items-center'>
              <span className='font-bold'> Latest Order </span>
              <Button type="button">
                <Link href={ADMIN_ORDER_SHOW}>View All</Link>
        ...
        <Card className='rounded-lg lg:w-[30%] w-full p-0 block'>
          <CardHeader className='py-3 border-b pb-3'>
            <div className='flex justify-between items-center'>
              <span className='font-bold'>Latest Review</span>
              <Button type="button">
                <Link href={ADMIN_REVIEW_SHOW}>View All</Link>
              </Button>
            </div>
          </CardHeader>
          <CardContent className='pt-3 px-0 lg:h-[350px] overflow-auto'>
            <LatestReview />
          </CardContent>
        </Card>
