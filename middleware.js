...
//             // if the user is not logged in & trying to access a protected route, redirect to login page
//             if (!pathname.startWith('/auth')) {
//                 return NextResponse.redirect(new URL(WEBSITE_LOGIN, request.nextUrl))
//             }
...
//         // protect admin route
//         if (pathname.startWith('/admin') && role !== 'admin') {
//             return NextResponse.redirect(new URL(WEBSITE_LOGIN, request.nextUrl))
//         }

//         // protect user routes
//         if (pathname.startWith('/my-account') && role !== 'user') {
//             return NextResponse.redirect(new URL(WEBSITE_LOGIN, request.nextUrl))
//         }
//         return NextResponse.next()
