            ...
            <div className='w-[calc(100%-100px)]'>
                <div>
                    ...
                    <p className='flex gap-2 items-center'>
                        ...
                        <span className='ml-3 text-gray-500'>{dayjs(review?.createdAt).fromNow()}</span>
                        <span className='flex items-center text-xs gap-1'>({review.rating} <IoStar className='text-yellow-500 '/>)</span>
                    </p>
