    ...
    <div>
      ...
      <Accordion type="multiple" defaultValue={['1', '2', '3', '4']}>
        ...
        <AccordionItem value="4">
          ...
          <AccordionContent>
            <Slider defaultValue={[0, 3000]} max={3000} step={1} onValueChange=
              {handlePriceChange} />
            ...
            <div className='mt-4'>
              <ButtonLoading onClick={handlePriceFilter}
                type="button"
                text="Filter Price"
                className="rounded-full bg-gradient-to-r from-primary via-primary/80 to-primary/60 text-white px-6 py-2 shadow-lg hover:opacity-90 transition"
              />
